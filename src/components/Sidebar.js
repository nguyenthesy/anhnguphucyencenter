  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <rect x="2" y="4" width="20" height="16" rx="2" /><line x1="2" y1="10" x2="22" y2="10" /><line x1="6" y1="14" x2="6" y2="14.01" /><line x1="10" y1="14" x2="14" y2="14" />
          </svg>
        ),
      },
      {
  ...
  return (
    <aside className={`sidebar ${className}`}>
      <div className="sidebar-logo">
        ...
        <div>
          <div className="sidebar-logo-text">Phúc Yên</div>
          <div className="sidebar-logo-sub">English Center</div>
        </div>
      </div>
      ...
      <div className="sidebar-user">
        ...
        <div className="sidebar-user-info">
          <div className="sidebar-user-name">{userData?.displayName || user?.email}</div>
